...
export default class Details extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      numReview:this.props.navigation.state.params?this.props.navigation.state.params.data.numReview:"",
      currentUserID:"",
    }
...
setVolume(valueProp){
  ...
  showDirectionLink(){
    ...
    <View>
          <TouchableOpacity onPress={()=> {
            ...
            <Image
              style={{height:200,width:width,marginTop:20}}
              source={{url: mapImage}}>
            </Image>
          </TouchableOpacity>
        </View>
  ...
  */
  ...
  phoneApp(){
    ...
    if((this.props.data.detailsSetup.fields.phone)&&(this.getExpectedValue('phoneNumber')!="")&&(this.state.currentUserID != ownerID)){
  ...
  showReview(){
    ...
    if((this.props.data.detailsSetup.reviewButton != null) && (this.state.numReview != 0)){
      return (
