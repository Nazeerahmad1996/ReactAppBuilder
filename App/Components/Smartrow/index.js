...
export default class SmartRow extends Component {
  ...
  render() {
    ...
    if(styleOfDisplay=="grid1"){
      ...
      return (
        <StandardRow title={this.getExpectedValue("title")} subtitle={this.getExpectedValue("subtitle")} image={this.getExpectedValue("image")} from={this.props.from} lastChat={this.getExpectedValue("lastChat")} />
      );
    }
